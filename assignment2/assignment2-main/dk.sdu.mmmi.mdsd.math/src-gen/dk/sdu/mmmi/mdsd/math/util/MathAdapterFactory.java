...
public class MathAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected MathSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseOrigen(Origen object)
      {
        return createOrigenAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link dk.sdu.mmmi.mdsd.math.Origen <em>Origen</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createOrigenAdapter()
  {
    return null;
  }
