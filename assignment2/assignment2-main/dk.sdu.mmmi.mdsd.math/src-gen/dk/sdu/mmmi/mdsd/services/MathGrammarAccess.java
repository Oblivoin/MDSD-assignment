...
public class MathGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class OrigenElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.mmmi.mdsd.Math.Origen");
		private final Assignment cXAssignment = (Assignment)rule.eContents().get(1);
		private final RuleCall cXMathExpParserRuleCall_0 = (RuleCall)cXAssignment.eContents().get(0);
		...
		//MathExp
		public RuleCall getXMathExpParserRuleCall_0() { return cXMathExpParserRuleCall_0; }
	}
	...
	public class ExpElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cExp1ParserRuleCall = (RuleCall)rule.eContents().get(1);
		...
		//Exp1
		public RuleCall getExp1ParserRuleCall() { return cExp1ParserRuleCall; }
	}
	public class Exp1Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.mmmi.mdsd.Math.Exp1");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final RuleCall cRightExp2ParserRuleCall_1_0_2_0 = (RuleCall)cRightAssignment_1_0_2.eContents().get(0);
		...
		private final RuleCall cRightExp2ParserRuleCall_1_1_2_0 = (RuleCall)cRightAssignment_1_1_2.eContents().get(0);
		...
		//({Plus.left=current} '+' right=Exp2 | {Minus.left=current} '-' right=Exp2)*
		public Alternatives getAlternatives_1() { return cAlternatives_1; }
		
		//{Plus.left=current} '+' right=Exp2
		...
		//Exp2
		public RuleCall getRightExp2ParserRuleCall_1_0_2_0() { return cRightExp2ParserRuleCall_1_0_2_0; }
		
		//{Minus.left=current} '-' right=Exp2
		...
		//Exp2
		public RuleCall getRightExp2ParserRuleCall_1_1_2_0() { return cRightExp2ParserRuleCall_1_1_2_0; }
	}
	public class Exp2Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "dk.sdu.mmmi.mdsd.Math.Exp2");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private final OrigenElements pOrigen;
	...
	public MathGrammarAccess(GrammarProvider grammarProvider,
		...
		this.pOrigen = new OrigenElements();
	...
	//    x+=MathExp*
	//;
	public OrigenElements getOrigenAccess() {
		return pOrigen;
	}
	
	public ParserRule getOrigenRule() {
		return getOrigenAccess().getRule();
	}
