 ...
 *   <li>{@link dk.sdu.mmmi.mdsd.math.impl.MathExpImpl#getExternalFunctions <em>External Functions</em>}</li>
...
public class MathExpImpl extends MinimalEObjectImpl.Container implements MathExp
{
  ...
  public EList<ExternalDeclaration> getExternalFunctions()
  {
    ...
    {
      externalFunctions = new EObjectContainmentEList<ExternalDeclaration>(ExternalDeclaration.class, this, MathPackage.MATH_EXP__EXTERNAL_FUNCTIONS);
    }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MathPackage.MATH_EXP__EXTERNAL_FUNCTIONS:
